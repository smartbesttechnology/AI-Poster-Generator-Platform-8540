...
function ToolPanel({ canvas, designHistory, onApplyDesign }) {
  ...
  const renderLayersTab = () => (
    <div className="space-y-4">
      <h4 className="text-white font-medium">Canvas Objects</h4>
        ...
        {canvas?.getObjects().map((obj, index) => (
          ...
          >
            <div className="flex items-center space-x-3">
              <SafeIcon 
                icon={obj.type === 'text' ? FiType : FiImage} 
  ...
  const renderTextTab = () => (
    <div className="space-y-4">
      ...
      >
        <SafeIcon icon={FiType} className="text-lg" />
        <span>Add Text</span>
      </motion.button>

      <div className="space-y-3">
        <h4 className="text-white font-medium">Font Styles</h4>
        {['Arial', 'Helvetica', 'Times New Roman', 'Georgia', 'Verdana'].map((font) => (
          <button
            ...
            className="w-full p-3 bg-white/5 hover:bg-white/10 rounded-lg text-white/80 text-left transition-all"
    ...
    <div className="space-y-4">
      <div className="grid grid-cols-2 gap-3">
        <motion.button
          ...
          className="bg-gradient-to-r from-pink-500 to-red-500 text-white py-3 rounded-lg font-semibold hover:from-pink-600 hover:to-red-600 transition-all"
        >
          Rectangle
        </motion.button>
        <motion.button
          ...
          className="bg-gradient-to-r from-green-500 to-blue-500 text-white py-3 rounded-lg font-semibold hover:from-green-600 hover:to-blue-600 transition-all"
        >
          Circle
        </motion.button>
        <motion.button
          ...
          className="bg-gradient-to-r from-yellow-500 to-orange-500 text-white py-3 rounded-lg font-semibold hover:from-yellow-600 hover:to-orange-600 transition-all col-span-2"
        >
          Triangle
        </motion.button>
      </div>
      ...
      <div className="space-y-3">
        <h4 className="text-white font-medium">Object Controls</h4>
        <div className="grid grid-cols-2 gap-2">
          <button
            onClick={duplicateObject}
            className="flex items-center justify-center space-x-2 bg-white/10 hover:bg-white/20 text-white py-2 rounded-lg transition-all"
          >
          ...
          <button
            ...
            className="flex items-center justify-center space-x-2 bg-red-600 hover:bg-red-700 text-white py-2 rounded-lg transition-all"
          >
            <SafeIcon icon={FiTrash2} className="text-sm" />
            <span>Delete</span>
          </button>
  ...
  const renderColorsTab = () => (
    <div className="space-y-4">
      <h4 className="text-white font-medium">Colors</h4>
